<?php 
    ...
    $id = $_GET['id'];
    $sql = "SELECT d.MaDonDatHang, d.NgayLap, d.TongThanhTien, t.TenHienThi, t.DiaChi, t.DienThoai, tt.MaTinhTrang, tt.TenTinhTrang FROM DonDatHang d, TaiKhoan t, TinhTrang tt WHERE d.MaTaiKhoan = t.MaTaiKhoan AND d.MaTinhTrang = tt.MaTinhTrang AND d.MaDonDatHang = $id ";
...
<fieldset>
    ...
    <a href="./pages/qlDonDatHang/xlDonHang.php?a=2&id=<?php echo $id ?>" class="btnGiaoHang"> Giao hàng</a>
    <a href="./pages/qlDonDatHang/xlDonHang.php?a=3&id=<?php echo $id ?>" class="btnThanhToan"> Thanh Toán</a>
    <a href="./pages/qlDonDatHang/xlDonHang.php?a=4&id=<?php echo $id ?>" class="btnHuy"> Giao hàng</a>
